...
<script setup>
import ListHeader from '../Picture/components/ListHeader.vue'
import FormDrawer from '../Picture/components/FormDrawer.vue'
import {
  getUserLevelList,
  createUserLevel,
  updateUserLevel,
...
} from '../Picture/api/level'

import { useInitTable, useInitForm } from '../Picture/api/useCommon.js'
